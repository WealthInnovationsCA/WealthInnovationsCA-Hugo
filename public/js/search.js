(() => {
  ...
  // ns-hugo:/home/david/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/krisk/!fuse@v7.0.0+incompatible/dist/fuse.js
  var require_fuse = __commonJS({
    "ns-hugo:/home/david/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/krisk/!fuse@v7.0.0+incompatible/dist/fuse.js"(exports, module) {
  ...
  // ns-hugo:/home/david/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.17.1/assets/search/js/dropdown.ts
  (() => {
    const hide = (dropdown) => {
  ...
  // ns-hugo:/home/david/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.17.1/assets/search/js/keyboard.ts
  var Keyboard = class {
    keys = {};
    events = [];
  ...
  // ns-hugo:/home/david/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.17.1/assets/search/js/navigator.ts
  var Navigator = class {
    modal() {
  ...
  // ns-hugo:/home/david/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.17.1/assets/search/js/i18n.ts
  var i18n = new Translator(params_default.i18n, params_default.defaultLang);
  var i18n_default = i18n;

  // ns-hugo:/home/david/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.17.1/assets/search/js/engine.ts
  ...
  // ns-hugo:/home/david/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.17.1/assets/search/js/historiographer.ts
  ...
  // ns-hugo:/home/david/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.17.1/assets/search/js/form.ts
  var Form = class {
  ...
  // ns-hugo:/home/david/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.17.1/assets/search/js/spinner.ts
  var Spinner = class {
    constructor(ele) {
      this.ele = ele;
    }
  ...
  // ns-hugo:/home/david/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.17.1/assets/search/js/renderer.ts
  var Renderer = class {
  ...
  // ns-hugo:/home/david/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.17.1/assets/search/js/shortcuts.ts
  var Navigate = {
    kbds: ["\u2191", "\u2193"],
...
<span class="search-shortcut-action">${shortcut["action"]}</span>
  ...
  // ns-hugo:/home/david/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.17.1/assets/search/js/modal.ts
  var searchShortcut = {
  ...
  // ns-hugo:/home/david/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/search@v0.17.1/assets/search/js/search.ts
  var Search = class {
    container;
    form;
    shortcuts;
