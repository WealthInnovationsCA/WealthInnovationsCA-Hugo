...
`;
  ...
  var color = "light";
  var content_panel = { bottom: "20px", comments: true, repo: { branch: "main", repo: "FilmonGebremeskel/WealthInnovationsCA-Hugo", service: "github" } };
  ...
  var header = { brand: "Wealth Innovations", breakpoint: "lg", full_width: true, logo_bg: "dark green", socials: { facebook: "foo", github: "WealthInnovations", instagram: "foo", linkedin: "foo", mastodon: "foo", twitter: "foo" }, sticky: true, theme_toggle: { style: "switch" } };
